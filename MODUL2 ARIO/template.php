...
if (isset($_POST["hitung"])) {
    ...
    if ($tinggi_badan == null || $berat_badan == null){
        $message = "Variabel kosong";
    };
    
    if ($tinggi_badan != null || $berat_badan != null){
        $convert = $tinggi_badan/100;
        $calulate =  $berat_badan / ($convert * $convert) ;
        $hasil = number_format($calulate,1);
            if ($hasil <= 18.4) {
                $status = "Underweight";
            } elseif ($hasil > 18.4 && $hasil < 25){
                $status = "Normal";
            } elseif ($hasil > 24.9 && $hasil < 40){
                $status = "Overweight";
            } else{
                $status = "Obese";
            }
...
<body>
    <div class="row">
        ...
        <div class="col-md-4 p-3">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Kalkulator BM</h4>
                    <form action="" method="POST">
                        ...
                        <button type="submit" name="hitung" class="btn btn-primary mb-3 mt-3 w-100">Hitung BMI</button>
                    </form>
